...
@Slf4j
public class HttpPacketDeserializer implements Deserializer<HapRequest>, ApplicationEventPublisherAware {

	private static final String LENGTH_HEADER = "Content-Length:";
	private static final String METHOD_SUFIX = "HTTP/1.1";
